...
### Running inside Ford SYNC 3

![WebSonora running on Ford SYNC 3 panel](./websonora_sync3.png)

> WebSonora running natively inside the Ford SYNC 3 in-dash infotainment system. The interface is rendered directly on the vehicle's touchscreen, with voice command support via the "Buscar" (Search) button and full AppLink integration.
